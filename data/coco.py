...
class CocoDataset(Dataset):
    ...
    def __init__(self, cfg, img_prefix, ann_file, class_name, img_size=224, train_mode=False, inp_name=None):
    ...
    def __getitem__(self, idx):
        ...
        if self.cfg.method =="SKD" and self.cfg.teacher_pretrained==True:
            return (img, self.inp), self.gt_labels[idx]
        else:
